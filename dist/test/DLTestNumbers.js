...
exports.DLStateList = exports.DLTestNumbers = void 0;
const DLTestNumbers = (state) => {
    const states = {
        ...
        LA: {
            criteria: '("0" + 7 Numeric) OR ("0" + 8 Numeric) OR 7 Numeric or 8 Numeric',
        ...
        MO: {
            criteria: "9 Numeric OR (1 Alpha + 5-9 Numeric) OR (3 Numeric + 1 Alpha + 6 Numeric)",
            valid: [
                "123456789",
                "A12345",
                "A123456",
        ...
        WA: {
            criteria: '4-8 Alpha + 2-3 Numeric + 2 Alpha-Numeric OR "WDL" + 9 Alpha-Numeric',
...
exports.DLTestNumbers = DLTestNumbers;
const DLStateList = () => {
    return [
        "AL",
        "AK",
...
exports.DLStateList = DLStateList;
module.exports = { DLStateList: exports.DLStateList, DLTestNumbers: exports.DLTestNumbers };
