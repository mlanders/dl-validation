...
class DLValidation {
    constructor() {
        this.states = {
            ...
            MO: new RegExp(/(\b\d{9}\b)|(\b[A-Z]{1}\d{5,9}\b)|(\b\d{3}[A-Z]{1}\d{6}\b)/),
            MT: new RegExp(/(\b\d{13}\b$)|(\b(\d|[A-Z]){9}\b$)|(\b[A-Z]{3}\d{10}\b$)/),
            ...
            WA: new RegExp(/(\b[A-Z*]{4,8}\d{2,3}(\d|[A-Z]){2}\b)|(\bWDL([A-Z]|\d){9}\b)/),
...
exports.default = new DLValidation();
